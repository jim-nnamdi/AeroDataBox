...
impl Flight{
    ...
    pub fn new(&self) -> Flight{
        ...
        arrival: Arrival{
            actual_time_local: NaiveDateTime::new(NaiveDate::from_ymd(2015, 6, 3), NaiveTime::from_hms_milli(12, 34, 56, 789)),
            actual_time_utc: NaiveDateTime::new(NaiveDate::from_ymd(2015, 6, 3), NaiveTime::from_hms_milli(12, 34, 56, 789)),
            airport: Airport{
            ...
            scheduled_time_local: NaiveDateTime::new(NaiveDate::from_ymd(2015, 6, 3), NaiveTime::from_hms_milli(12, 34, 56, 789)),
            scheduled_time_utc: NaiveDateTime::new(NaiveDate::from_ymd(2015, 6, 3), NaiveTime::from_hms_milli(12, 34, 56, 789)),
